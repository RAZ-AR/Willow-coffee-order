...
const HeroSection = ({ lang, onPrimaryCta, cardNumber, stars, isLoadingCard, }) => {
    ...
    return (_jsx("section", { className: "mb-5 mt-4 animate-slideUp", children: _jsxs("div", { className: "glass-panel px-5 py-4 rounded-3xl", children: [_jsxs("div", { className: "flex items-start gap-3 mb-4", children: [_jsx("div", { className: "shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br from-accent/20 to-accent/10 border border-accent/40 flex items-center justify-center text-2xl shadow-lg shadow-accent/20 animate-scaleIn", children: "\u2615" }), _jsxs("div", { className: "flex-1", children: [_jsx("h1", { className: "text-[21px] font-bold leading-snug text-gray-800", children: t.title }), _jsx("p", { className: "mt-1.5 text-xs text-gray-600 leading-relaxed", children: t.subtitle })] })] }), _jsx("button", { onClick: onPrimaryCta, className: "w-full rounded-2xl bg-gradient-to-r from-accent to-teal-400 text-black font-bold text-sm py-3 shadow-lg shadow-accent/50 hover:shadow-xl hover:shadow-accent/60 active:scale-[0.98] transition-all duration-200 hover:-translate-y-0.5", children: t.ctaPrimary }), _jsxs("div", { className: "mt-4 flex flex-col gap-2 text-xs text-gray-700", children: [_jsxs("div", { className: "flex items-center gap-2 group", children: [_jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-accent shadow-sm shadow-accent/50 group-hover:scale-125 transition-transform" }), _jsx("span", { className: "group-hover:text-gray-900 transition-colors", children: t.uspFast })] }), _jsxs("div", { className: "flex items-center gap-2 group", children: [_jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-accent shadow-sm shadow-accent/50 group-hover:scale-125 transition-transform" }), _jsx("span", { className: "group-hover:text-gray-900 transition-colors", children: t.uspStars })] }), _jsxs("div", { className: "flex items-center gap-2 group", children: [_jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-accent shadow-sm shadow-accent/50 group-hover:scale-125 transition-transform" }), _jsx("span", { className: "group-hover:text-gray-900 transition-colors", children: t.uspLanguage })] })] }), _jsxs("div", { className: "mt-4 flex items-center gap-2 text-xs", children: [_jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-gray-100 border border-gray-300 hover:border-gray-400 transition-colors", children: [_jsx("span", { children: "\uD83D\uDCB3" }), _jsx("span", { className: "font-semibold text-gray-800", children: isLoadingCard ? "#…" : hasCard ? `#${cardNumber}` : "Нет карты" })] }), _jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-amber-100 border border-amber-300 hover:border-amber-400 transition-colors", children: [_jsx("span", { children: "\u2B50" }), _jsx("span", { className: "font-semibold text-amber-800", children: isLoadingCard
                                        ? "—"
                                        : hasCard
                                            ? `${stars} звёзд`
                                            : "Начните копить" })] })] })] }) }));
...
export default function App() {
    ...
    // Show loading state
    if (menuLoading) {
        return (_jsx("div", { className: "min-h-screen bg-app-gradient flex items-center justify-center text-gray-800", children: _jsxs("div", { className: "text-center animate-fadeIn", children: [_jsx("div", { className: "mb-6 inline-block", children: _jsx("div", { className: "w-20 h-20 rounded-3xl bg-gradient-to-br from-accent/20 to-accent/10 border-2 border-accent/40 flex items-center justify-center text-4xl shadow-2xl shadow-accent/30 animate-bounce", children: "\u2615" }) }), _jsx("div", { className: "text-2xl font-bold tracking-wide mb-2 text-gray-800", children: BRAND.name }), _jsxs("div", { className: "text-sm text-gray-600 mt-2 flex items-center justify-center gap-2", children: [_jsxs("div", { className: "flex gap-1", children: [_jsx("span", { className: "w-2 h-2 bg-accent rounded-full animate-pulse", style: { animationDelay: '0ms' } }), _jsx("span", { className: "w-2 h-2 bg-accent rounded-full animate-pulse", style: { animationDelay: '150ms' } }), _jsx("span", { className: "w-2 h-2 bg-accent rounded-full animate-pulse", style: { animationDelay: '300ms' } })] }), _jsx("span", { children: "Loading menu" })] })] }) }));
    }
    // Show error state
    if (menuError) {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-app-gradient text-gray-800", children: [_jsx(Header, { cardNumber: loyalty.cardNumber, isLoadingCard: loyalty.isLoadingCard, lang: lang, setLang: setLang, stars: loyalty.stars, cartCount: cart.cartCount, onOpenCart: () => setShowCart(true), onLogoTap: handleLogoTap }), _jsxs("div", { className: "px-4 pb-28 max-w-md mx-auto", children: [_jsx(HeroSection, { lang: lang, cardNumber: loyalty.cardNumber, stars: loyalty.stars, isLoadingCard: loyalty.isLoadingCard, onPrimaryCta: () => {
