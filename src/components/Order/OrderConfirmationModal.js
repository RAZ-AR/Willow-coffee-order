...
export const OrderConfirmationModal = ({ isOpen, lang, starsEarned, orderNumber, onClose, items = [], total = 0, payment, when, table, cardNumber }) => {
    if (!isOpen)
        return null;
