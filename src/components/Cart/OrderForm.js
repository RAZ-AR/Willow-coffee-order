...
export const OrderForm = ({ lang, total, onSubmit }) => {
    ...
    return (_jsxs("div", { className: "px-5 pb-5 pt-4", children: [_jsxs("div", { className: "p-4 rounded-2xl border border-gray-200 shadow-sm bg-form", children: [_jsxs("div", { className: "text-sm font-bold mb-3 text-gray-700 flex items-center gap-2", children: [_jsx("span", { children: "\u23F0" }), lang === "ru"
                                ? "Когда приготовить"
                                : lang === "sr"
                                    ? "Kada pripremiti"
                            ...
                            { v: "20", label: "+20 min" },
                                ...
                                : "bg-white !text-black border-gray-200 hover:border-gray-300 hover:bg-gray-50 active:scale-95"}`, children: option.label }, option.v))) }), when === "now" && (_jsxs("div", { className: "mt-4 animate-slideUp", children: [_jsx("div", { className: "text-sm font-semibold text-gray-700 mb-2", children: lang === "ru"
                                    ...
                                    .map((n) => (_jsx("button", { onClick: () => setTable(n), className: `py-2.5 rounded-xl border-2 text-sm font-semibold transition-all duration-200 ${table === n
                                        ...
                                        : "bg-white !text-black border-gray-200 hover:border-gray-300 hover:bg-gray-50 active:scale-95"}`, children: n }, n))) })] }))] }), _jsxs("div", { className: "mt-3 p-4 rounded-2xl border border-gray-200 shadow-sm bg-form", children: [_jsxs("div", { className: "text-sm font-bold mb-3 text-gray-700 flex items-center gap-2", children: [_jsx("span", { children: "\uD83D\uDCB3" }), lang === "ru" ? "Оплата" : lang === "sr" ? "Plaćanje" : "Payment"] }), _jsx("div", { className: "flex gap-2", children: [
                            {
                                v: "cash",
